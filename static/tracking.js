...
// Function to reset all tracking variables
...
document.addEventListener('keydown', () => {
    if (!timerStarted) return; // Only track typing if timer has started
...
window.addEventListener("scroll", (event) => {
    if (!timerStarted) return; // Only track scroll if timer has started
